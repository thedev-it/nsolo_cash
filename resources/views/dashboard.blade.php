<x-app-layout>
    ...
    <div class="max-w-6xl mx-auto space-y-8">
        ...
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Bienvenue, {{ explode(' ', auth()->user()->name)[0] }}</h1>
            <p class="text-gray-500 mt-1">Suis l'évolution de tes finances en temps réel.</p>
        </div>
        ...
        <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div class="bg-white rounded-xl border border-gray-100 p-5">
                ...
                <p class="text-2xl font-bold text-gray-900">{{ number_format($totalBalance, 2) }} €</p>
            ...
            <div class="bg-white rounded-xl border border-gray-100 p-5">
                ...
                <p class="text-2xl font-bold text-red-500">{{ number_format($monthExpenses, 2) }} €</p>
            ...
            <div class="bg-white rounded-xl border border-gray-100 p-5">
                ...
                <p class="text-2xl font-bold text-emerald-500">{{ number_format($monthIncome, 2) }} €</p>
            ...
            <div class="bg-white rounded-xl border border-gray-100 p-5">
                ...
                <p class="text-2xl font-bold {{ ($monthIncome - $monthExpenses) >= 0 ? 'text-gray-900' : 'text-red-500' }}">
        ...
        <div class="bg-white rounded-xl border border-gray-100">
            <div class="flex items-center justify-between px-6 py-4 border-b border-gray-100">
                ...
                <a href="{{ route('transactions.index') }}" class="text-sm text-indigo-600 hover:underline">Voir tout</a>
            </div>
        ...
        <div class="bg-white rounded-xl border border-gray-100">
            <div class="flex items-center justify-between px-6 py-4 border-b border-gray-100">
                ...
                <a href="{{ route('accounts.create') }}" class="text-sm text-indigo-600 hover:underline">+ Ajouter</a>
            </div>

            @if ($accounts->isEmpty())
                <div class="p-10 text-center text-sm text-gray-500">
                    Aucun compte pour le moment.
                    <a href="{{ route('accounts.create') }}" class="text-indigo-600 underline">Créer ton premier compte</a>
                </div>
            @else
                <ul class="divide-y divide-gray-50">
                    @foreach ($accounts as $account)
                        <li class="px-6 py-4 flex items-center justify-between">
                            ...
                            <span class="text-sm font-semibold {{ $account->balance >= 0 ? 'text-gray-900' : 'text-red-500' }}">
    ...
    <a href="{{ route('transactions.create') }}"
       class="fixed bottom-8 right-8 w-14 h-14 bg-indigo-600 hover:bg-indigo-700 rounded-full shadow-lg flex items-center justify-center text-white transition">
