<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">Modifier le budget</h2>
    </x-slot>
        ...
        <div class="bg-white p-6 rounded-xl border border-gray-100">
            <form action="{{ route('budgets.update', $budget) }}" method="POST">
                ...
                <div class="flex justify-end gap-3">
                    <a href="{{ route('budgets.index') }}" class="px-4 py-2 text-sm text-gray-600 hover:text-gray-900">Annuler</a>
